...
namespace PhoneConnectionConfig;

//https://github.com/RickyDivjakovski/CoolADB
public partial class ADBClient : Component
{
    ...
    // Create a background thread and assign work event to our emulated shell method
    ...
    private void SendCommand(string command)
    {
        ...
        Command = command;
        CMD.RunWorkerAsync();
        while (!Complete) Thread.Sleep(200);
        Complete = false;
    }
    ...
    public void ScreenCap(string fileLocation)
    {
        Execute(@"screencap /sdcard/Pictures/Screenshots/Screenshot_manual.png", false);
        Pull(@"/sdcard/Pictures/Screenshots/Screenshot_manual.png", fileLocation);
    }
